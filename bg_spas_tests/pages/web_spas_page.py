...
class WebSpas:
    ...
    def open_spas_card(self):
        card_number = mobileSpas.card_number
        sleep(5)
    ...
    def checking_sync_organization(self):
        expected_organization = mobileSpas.random_organization
    ...
    def checking_sync_division(self):
        expected_division = mobileSpas.random_division
    ...
    def checking_sync_object(self):
        expected_object = mobileSpas.random_object
    ...
    def checking_sync_type_card(self):
        expected_type_card = mobileSpas.card_number
    ...
    def checking_sync_participation(self):
        expected_participation = mobileSpas.random_participation
    ...
    def checking_sync_description(self):
        expected_description = mobileSpas.random_description
    ...
    def checking_sync_suggested(self):
        expected_suggested = mobileSpas.random_suggested
    ...
    def checking_sync_measures(self):
        expected_measures = mobileSpas.random_measures
    ...
    def checking_sync_full_name(self):
        expected_name = mobileSpas.random_name
    ...
    def checking_sync_fix_date(self):
        expected_fix_date = mobileSpas.random_fix_date
    ...
    def checking_sync_when_fix_date(self):
        expected_when_fix_date = mobileSpas.random_when_fix_date
    ...
    def checking_sync_hazard_category(self):
        expected_hazard_category = mobileSpas.random_hazard_category
    ...
    def checking_sync_damage_category(self):
        expected_damage_category = mobileSpas.random_damage_category
    ...
    def checking_sync_damage_subcategory(self):
        expected_damage_subcategory = mobileSpas.random_damage_subcategory
    ...
    def checking_sync_severity(self):
        expected_severity = mobileSpas.random_severity
    ...
    def checking_sync_probability(self):
        expected_probability = mobileSpas.random_probability
